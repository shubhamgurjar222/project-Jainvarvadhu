                        ...
                        <div className="col-md-4 col-lg-3">
                            <div className="db-nav">
                                ...
                                <div className="db-nav-list">
                                    <ul>
                                        <li><Link href="user-dashboard" className="act"><i className="fa fa-tachometer" aria-hidden="true"></i>Dashboard</Link></li>
                                        <li><Link href="user-profile"><i className="fa fa-male" aria-hidden="true"></i>Profile</Link></li>
                                        <li><Link href="user-interests"><i className="fa fa-handshake-o" aria-hidden="true"></i>Interests</Link></li>
                                        <li><Link href="user-chat"><i className="fa fa-commenting-o" aria-hidden="true"></i>Chat list</Link></li>
                                        <li><Link href="user-plan"><i className="fa fa-money" aria-hidden="true"></i>Plan</Link></li>
                                        <li><Link href="user-setting"><i className="fa fa-cog" aria-hidden="true"></i>Setting</Link></li>
                                        <li><Link href="#"><i className="fa fa-sign-out" aria-hidden="true"></i>Log out</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
